...
export const MERCH_PRODUCTS: MerchProduct[] = [
  ...
  { slug: "trucker-hat", name: "Trucker Hat", category: "Hats", emoji: "🧢",
    blurb: "A classic look with modern comfort — structured front, breathable mesh back, and an adjustable snapback.",
    variantLabel: "Color", variants: ["Navy", "Black", "Charcoal", "Olive", "Khaki", "White", "Red"],
    sheets: [{ wordmark: "Undecided 2028", src: "/merch/trucker-hat-undecided-sheet.webp" }],
    price: "$30", featured: true },
