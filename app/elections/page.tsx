    ...
    <div style={{ background: C.page, minHeight: "100vh", color: C.ink900 }}>
      ...
      <div className="max-w-[1100px] mx-auto px-3 pt-3 pb-10 grid grid-cols-1 gap-2 items-start lg:grid-cols-[1fr_320px] lg:gap-4 lg:px-6 lg:pt-4">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          {/* News bridge — pull ballot-focused visitors into the spectrum news */}
          <div style={{ ...cardStyle(), background: C.ink900, padding: "18px 20px", marginTop: 4 }}>
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", color: "#C7CAD1", margin: "0 0 6px" }}>
              The story behind the ballot
            </p>
            ...
            <p style={{ fontSize: 13.5, color: "rgba(255,255,255,0.75)", lineHeight: 1.55, margin: "0 0 14px" }}>
              Knowing who&rsquo;s running is half of it. See the day&rsquo;s political news covered from the left, center, and right — side by side, so you decide for yourself.
            </p>
