    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="prose prose-gray max-w-none space-y-8 text-[#4A4A4A]/80">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">2. Description of Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">3. Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">4. Community Guidelines</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">5. Content and Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">6. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">7. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">8. Changes to These Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">9. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#4A4A4A]">10. Contact</h2>
