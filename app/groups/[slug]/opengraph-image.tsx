    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ display: "flex", alignItems: "center", fontSize: 24, fontWeight: 700, letterSpacing: 2, color: "#030213", marginBottom: 18 }}>
            LOCAL ISSUE
            <span style={{ display: "flex", width: 7, height: 7, borderRadius: 7, background: "#030213", margin: "0 14px" }} />
            {place}
          </div>
          <div style={{ fontSize: 60, fontWeight: 800, color: "#030213", lineHeight: 1.1, maxWidth: 1000 }}>
            {name}
          </div>
        </div>
